    ...
    return {
        tools: [
            ...
            },
            {
                ...
                description: '[OPTIONAL] Check the processing status of a PDF extraction session. ' +
            ...
            },
            {
                ...
                description: '[OPTIONAL] Retrieve the extracted content from a completed session. ' +
            ...
            content: [
                {
                    ...
                    text: JSON.stringify({
                        ...
                        nextStep: processResult.status === 'completed'
